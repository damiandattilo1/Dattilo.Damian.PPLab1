...
{
    printf(" %4d   %4d   %4d     %d/%d/%d\n", unTrabajo.id, unTrabajo.idBici, unTrabajo.idServicio, unTrabajo.fecha.dia, unTrabajo.fecha.mes, unTrabajo.fecha.anio);//Imprime los datos de la persona segun su posicion en el vector
}
